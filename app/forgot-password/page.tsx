...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError("Impossibile completare la richiesta. Riprova più tardi.")
    } finally {
      setLoading(false)
    }
  }
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm text-slate-300 mb-6">
            Inserisci l'indirizzo email associato al tuo account e ti invieremo le istruzioni per reimpostare la password.
          </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <label className="block">
                ...
                <input
                  ...
                  aria-label="Email per recuperare la password"
                  required
                />
              </label>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p className="text-sm text-slate-300 mt-1">
                  Ti abbiamo inviato un link per reimpostare la password a <span className="font-medium">{email}</span>. Controlla anche la cartella spam se non lo vedi subito.
                </p>
              </motion.div>
